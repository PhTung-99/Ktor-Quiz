package dev.timpham.data.database.datetypes
...
class TimestampWithTimeZoneColumnType : ColumnType(), IDateColumnType {
 ...
 */
fun Table.timestampWithTimeZone(name: String): Column<Instant> = registerColumn(name, TimestampWithTimeZoneColumnType())