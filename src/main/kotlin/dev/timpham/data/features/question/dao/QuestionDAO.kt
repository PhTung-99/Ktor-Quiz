...
interface QuestionDAO {
    ...
    suspend fun createQuestion(content: String, highlight: String?, isMultipleChoice: Boolean, score: Int, quizId: UUID): Question
    suspend fun updateQuestion(id: UUID, content: String, highlight: String?, isMultipleChoice: Boolean, score: Int, quizId: UUID): Question?
